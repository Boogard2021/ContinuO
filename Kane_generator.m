...
%% Dynamic Equations
% Left Side
Vfr_1=[dXfr_1 dYfr_1 dZfr_1];Afr_1=[ddXfr_1 ddYfr_1 ddZfr_1+g(3)];
Vfl_1=[dXfl_1 dYfl_1 dZfl_1];Afl_1=[ddXfl_1 ddYfl_1 ddZfl_1+g(3)];
Vhr_1=[dXhr_1 dYhr_1 dZhr_1];Ahr_1=[ddXhr_1 ddYhr_1 ddZhr_1+g(3)];
Vhl_1=[dXhl_1 dYhl_1 dZhl_1];Ahl_1=[ddXhl_1 ddYhl_1 ddZhl_1+g(3)];

Vfr_2=[dXfr_2 dYfr_2 dZfr_2];Afr_2=[ddXfr_2 ddYfr_2 ddZfr_2+g(3)];
Vfl_2=[dXfl_2 dYfl_2 dZfl_2];Afl_2=[ddXfl_2 ddYfl_2 ddZfl_2+g(3)];
Vhr_2=[dXhr_2 dYhr_2 dZhr_2];Ahr_2=[ddXhr_2 ddYhr_2 ddZhr_2+g(3)];
Vhl_2=[dXhl_2 dYhl_2 dZhl_2];Ahl_2=[ddXhl_2 ddYhl_2 ddZhl_2+g(3)];

Vfr_3=[dXfr_3 dYfr_3 dZfr_3];Afr_3=[ddXfr_3 ddYfr_3 ddZfr_3+g(3)];
Vfl_3=[dXfl_3 dYfl_3 dZfl_3];Afl_3=[ddXfl_3 ddYfl_3 ddZfl_3+g(3)];
Vhr_3=[dXhr_3 dYhr_3 dZhr_3];Ahr_3=[ddXhr_3 ddYhr_3 ddZhr_3+g(3)];
Vhl_3=[dXhl_3 dYhl_3 dZhl_3];Ahl_3=[ddXhl_3 ddYhl_3 ddZhl_3+g(3)];
Vhr_4=[dXhr_4 dYhr_4 dZhr_4];Ahr_4=[ddXhr_4 ddYhr_4 ddZhr_4+g(3)];
Vhl_4=[dXhl_4 dYhl_4 dZhl_4];Ahl_4=[ddXhl_4 ddYhl_4 ddZhl_4+g(3)];

Vb_E=[dXb_E dYb_E dZb_E]; Ab_E=[ddXb_E ddYb_E ddZb_E+g(3)];

L1=(m_b*Ab_E*jacobian(Vb_E,dq)+m_hip*(Afr_1*jacobian(Vfr_1,dq)+Afl_1*jacobian(Vfl_1,dq)+Ahr_1*jacobian(Vhr_1,dq)+Ahl_1*jacobian(Vhl_1,dq))+...
    m_sh*(Afr_3*jacobian(Vfr_3,dq)+Afl_3*jacobian(Vfl_3,dq)+Ahr_4*jacobian(Vhr_4,dq)+Ahl_4*jacobian(Vhl_4,dq))+ ...
    m_th_f*(Afr_2*jacobian(Vfr_2,dq)+Afl_2*jacobian(Vfl_2,dq))+m_th_h*(Ahr_2*jacobian(Vhr_2,dq)+Ahl_2*jacobian(Vhl_2,dq))+m_th_h_mid*(Ahr_3*jacobian(Vhr_3,dq)+Ahl_3*jacobian(Vhl_3,dq))).';
L2=(jacobian(w_b,dq)'*Ib_E*a_b+jacobian(w_hip_fr,dq)'*Ihk1_E*a_hip_fr+jacobian(w_hip_fl,dq)'*Ihk2_E*a_hip_fl+jacobian(w_hip_hr,dq)'*Ihk3_E*a_hip_hr+jacobian(w_hip_hl,dq)'*Ihk4_E*a_hip_hl+...
    jacobian(w_th_fr,dq)'*Ikf1_E*a_th_fr+jacobian(w_th_fl,dq)'*Ikf2_E*a_th_fl+jacobian(w_th_hr,dq)'*Ikf3_E*a_th_hr+jacobian(w_th_hl,dq)'*Ikf4_E*a_th_hl+...
    jacobian(w_th_mid_hr,dq)'*Ikf_mid_3_E*a_th_mid_hr+jacobian(w_th_mid_hl,dq)'*Ikf_mid_4_E*a_th_mid_hl+...
    jacobian(w_sh_fr,dq)'*Ife1_E*a_sh_fr+jacobian(w_sh_fl,dq)'*Ife2_E*a_sh_fl+jacobian(w_sh_hr,dq)'*Ife3_E*a_sh_hr+jacobian(w_sh_hl,dq)'*Ife4_E*a_sh_hl);
LeftSide=L1+L2;

% Right Side
B=[eye(14);zeros(6,14)];

RightSide_fr=[B,JL_e2.',JL_e3.']; % front right & hind left legs are in swing phase 
RightSide_fl=[B,JL_e1.',JL_e4.']; % hind right & front left legs are in swing phase
RightSide_1=[B,JL_e1.',JL_e2.',JL_e3.',JL_e4.']; % four legs are in support phase 

%% Creating m-file Equations

% CurrentFolder=cd('Dynamic Model'); % Change Matlab Current Foldet to Dynamic Model

% Flat_Kane_fl
ID=fopen('Flat_Kane_fl.m','w');
fprintf(ID,'function [Mfr_1,Mfr_2,Mfr_3,Mfl_1,Mfl_2,Mfl_3,Mhr_1,Mhr_2,Mhr_3,Mhr_4,Mhl_1,Mhl_2,Mhl_3,Mhl_4,Fx_fr,Fy_fr,Fz_fr,Fx_fl,Fy_fl,Fz_fl,Fx_hr,Fy_hr,Fz_hr,Fx_hl,Fy_hl,Fz_hl]=Flat_Kane_fl(q1_fr,q2_fr,q3_fr,q1_fl,q2_fl,q3_fl,q1_hr,q2_hr,q3_hr,q4_hr,q1_hl,q2_hl,q3_hl,q4_hl,x_p,y_p,z_p,alpha_p,beta_p,gamma_p,dq1_fr,dq2_fr,dq3_fr,dq1_fl,dq2_fl,dq3_fl,dq1_hr,dq2_hr,dq3_hr,dq4_hr,dq1_hl,dq2_hl,dq3_hl,dq4_hl,dx_p,dy_p,dz_p,dalpha_p,dbeta_p,dgamma_p,ddq1_fr,ddq2_fr,ddq3_fr,ddq1_fl,ddq2_fl,ddq3_fl,ddq1_hr,ddq2_hr,ddq3_hr,ddq4_hr,ddq1_hl,ddq2_hl,ddq3_hl,ddq4_hl,ddx_p,ddy_p,ddz_p,ddalpha_p,ddbeta_p,ddgamma_p)\n');
...
% Flat_Kane_fr
ID=fopen('Flat_Kane_fr.m','w');
fprintf(ID,'function [Mfr_1,Mfr_2,Mfr_3,Mfl_1,Mfl_2,Mfl_3,Mhr_1,Mhr_2,Mhr_3,Mhr_4,Mhl_1,Mhl_2,Mhl_3,Mhl_4,Fx_fr,Fy_fr,Fz_fr,Fx_fl,Fy_fl,Fz_fl,Fx_hr,Fy_hr,Fz_hr,Fx_hl,Fy_hl,Fz_hl]=Flat_Kane_fr(q1_fr,q2_fr,q3_fr,q1_fl,q2_fl,q3_fl,q1_hr,q2_hr,q3_hr,q4_hr,q1_hl,q2_hl,q3_hl,q4_hl,x_p,y_p,z_p,alpha_p,beta_p,gamma_p,dq1_fr,dq2_fr,dq3_fr,dq1_fl,dq2_fl,dq3_fl,dq1_hr,dq2_hr,dq3_hr,dq4_hr,dq1_hl,dq2_hl,dq3_hl,dq4_hl,dx_p,dy_p,dz_p,dalpha_p,dbeta_p,dgamma_p,ddq1_fr,ddq2_fr,ddq3_fr,ddq1_fl,ddq2_fl,ddq3_fl,ddq1_hr,ddq2_hr,ddq3_hr,ddq4_hr,ddq1_hl,ddq2_hl,ddq3_hl,ddq4_hl,ddx_p,ddy_p,ddz_p,ddalpha_p,ddbeta_p,ddgamma_p)\n');
...
% Flat_Kane
ID=fopen('Flat_Kane2_1.m','w');
fprintf(ID,'function [Mfr_1,Mfr_2,Mfr_3,Mfl_1,Mfl_2,Mfl_3,Mhr_1,Mhr_2,Mhr_3,Mhr_4,Mhl_1,Mhl_2,Mhl_3,Mhl_4,Fx_fr,Fy_fr,Fz_fr,Fx_fl,Fy_fl,Fz_fl,Fx_hr,Fy_hr,Fz_hr,Fx_hl,Fy_hl,Fz_hl]=Flat_Kane2_1(q1_fr,q2_fr,q3_fr,q1_fl,q2_fl,q3_fl,q1_hr,q2_hr,q3_hr,q4_hr,q1_hl,q2_hl,q3_hl,q4_hl,x_p,y_p,z_p,alpha_p,beta_p,gamma_p,dq1_fr,dq2_fr,dq3_fr,dq1_fl,dq2_fl,dq3_fl,dq1_hr,dq2_hr,dq3_hr,dq4_hr,dq1_hl,dq2_hl,dq3_hl,dq4_hl,dx_p,dy_p,dz_p,dalpha_p,dbeta_p,dgamma_p,ddq1_fr,ddq2_fr,ddq3_fr,ddq1_fl,ddq2_fl,ddq3_fl,ddq1_hr,ddq2_hr,ddq3_hr,ddq4_hr,ddq1_hl,ddq2_hl,ddq3_hl,ddq4_hl,ddx_p,ddy_p,ddz_p,ddalpha_p,ddbeta_p,ddgamma_p)\n');
...
fprintf(ID,'end');
fclose(ID);
% cd(CurrentFolder); % Change Matlab Current Foldet to Default